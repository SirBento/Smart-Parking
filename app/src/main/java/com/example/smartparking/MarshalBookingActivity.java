...
public class MarshalBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marshal_booking);

        searchView = findViewById(R.id.MarshalBookingSearchView);
        ...
        recyclerView = findViewById(R.id.MarshalBookinghistorylist);
        noHistoryText = findViewById(R.id.MarshalBookingnoHistoryText);
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
             if(snapshot.exists()) {
                 ...
                 Toast.makeText(MarshalBookingActivity.this, "No booking tickets yet", Toast.LENGTH_LONG).show();
        ...
        //
        LoadingDialog loadingDialog = new LoadingDialog(MarshalBookingActivity.this);
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent( MarshalBookingActivity.this, MarshalHomeActivity.class) );
        finish();
    }
}